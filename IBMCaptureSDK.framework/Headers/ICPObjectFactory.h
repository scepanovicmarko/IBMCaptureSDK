...
@protocol ICPService, ICPBoxService,
...
/**
 ...
 @param folderName      Name of the folder in the Box server
 @param folderId        Id of the folder in the Box server
 @param parentFolderId  Id of the parent folder in the Box server
 @return A managed object which conforms to the ICPDataService protocol.
 */
- (id<ICPBoxService>)boxServiceWithFolderName:(NSString *)folderName
 ...
 */
- (id<ICPBatch>)batchWithService:(nullable id<ICPService>)datacapService type:(nullable id<ICPBatchType>)batchType;
